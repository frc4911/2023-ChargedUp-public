...
public class Transform2d {
    ...
    public Transform2d(Pose2d initial, Pose2d last) {
        ...
        m_translation =
                last.getTranslation()
                        .translateBy(initial.getTranslation().inverse())
    ...
    public Transform2d times(double scalar) {
        return new Transform2d(m_translation.scale(scalar), m_rotation.times(scalar));
    }
    ...
    public Transform2d inverse() {
        ...
        return new Transform2d(
                getTranslation().inverse().rotateBy(getRotation().inverse()),
                getRotation().inverse());
    }
