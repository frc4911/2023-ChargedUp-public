...
import libraries.cheesylib.spline.Spline;
...
public class TrajectoryUtil {
    ...
    public static Trajectory<Pose2dWithCurvature> trajectoryFromPathFollower(IPathFollower path_follower,
        ...
        while (!path_follower.isDone()) {
            ...
            final Translation2d raw_steering = path_follower.steer(current_state.getPose());
            final Twist2d raw_steering_command = new Twist2d(raw_steering .x(), raw_steering .y(), raw_steering .direction().getRadians());
